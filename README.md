...
## CICD Infra setup
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated-infra" (https://github.com/lwersiy/devops-fully-automated-infra-terra-jenks.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated-infra" (https://github.com/lwersiy/devops-fully-automated-infra-terra-jenks.git) & name it "devops-fully-automated-infra"**
...
2) ###### Jenkins
    ...
    - User data (Copy the following user data): https://github.com/lwersiy/devops-fully-automated-infra-terra-jenks/blob/Installation/JenkinsUserdata
    - Launch Instance
